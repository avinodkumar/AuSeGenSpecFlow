...
namespace BuildPackageTool
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string binPath = projectFileName.Replace("EDMCAutomation.sln", "bin");
            //string binPath = string.Format(@"{0}\..\..\..\..\bin", Directory.GetCurrentDirectory());
            string DestinationToolsPath = projectFileName.Replace("EDMCAutomation.sln", @"bin\Tools");
            //string DestinationToolsPath = string.Format(@"{0}\..\..\..\..\bin\Tools", Directory.GetCurrentDirectory());
            string ToolsPath = projectFileName.Replace("EDMCAutomation.sln","Tools");                       
        ...
        {
            string solutionFile = string.Format(@"{0}\..\..\..\..\EDMCAutomation.sln", Directory.GetCurrentDirectory());
            ...
            {
                return string.Format(@"{0}\EDMCAutomation.sln",ConfigurationManager.AppSettings["SolutionPath"].ToString());                
            }
        }
    }
}
