...
namespace UIAccess.WebControls
{
    public class WebControl
    {
        ...
        {
            get { return Control.SpecificText; }
        }
        ...
        //private Locator customXpath;
        //public Locator customXpathLocator
        //{
        //    get
        //    {
        //        if (null == customXpath)
        //        {
        //            return new Locator(string.Format("{0}/li[text()='" + Argosy University, Phoenix + "']", locator), LocatorType.Xpath);
        //        }
        //        else
        //        {
        //            return customXpath;
        ...
        private Locator customXpath;
        public Locator customXpathLocator(string text)
        {
            if (null == customXpath)
            {
                return new Locator(string.Format("{0}/li[text()='" + text + "']", locator), LocatorType.Xpath);
            }
            else
            {
                return customXpath;
        ...
        {
            Control.WaitForVisible();
        }

        public bool WaitForEleVisible()
        {
            return Control.WaitForEleVisible();
        }
        ...
        public bool WaitForFrameVisible()
        {
            try
            {
                return Control.FrameVisibleWait();
            }
            catch (Exception)
            {
                return false;
